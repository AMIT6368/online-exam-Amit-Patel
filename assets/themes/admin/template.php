...
<body class="<?php echo xss_clean($is_rtl); ?>">
   ...
   <div class="main-sidebar sidebar-style-2" tabindex="1" >
      <aside id="sidebar-wrapper">
         ...
         <li class="dropdown<?php echo (strstr(uri_string(), 'admin/payment')) ? ' active' : ''; ?>">
            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
               <i class="fas fa-hand-holding-usd"></i>
               <span><?php echo lang('dashboard_payment'); ?></span> 
            </a>
            <ul class="dropdown-menu">
...
<li class="dropdown<?php echo (strstr(uri_string(), 'admin/blog')) ? ' active' : ''; ?>">
   <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
      <i class="fab fa-blogger-b"></i>
      <span><?php echo lang('admin_blog'); ?></span>
   </a>
   <ul class="dropdown-menu">
      <li class="<?php echo (uri_string() == 'admin/blog') ? 'active' : ''; ?>">
         <a href="<?php echo base_url('admin/blog'); ?>" class="nav-link"> <?php echo lang('admin_blog_category_list'); ?> 
         </a>
      </li>
      <li class="<?php echo (uri_string() == 'admin/blog/post') ? 'active' : ''; ?>">
         <a href="<?php echo base_url('admin/blog/post'); ?>" class="nav-link"> <?php echo lang('admin_post_list'); ?>
         </a>
      </li>
   </ul>
</li>
